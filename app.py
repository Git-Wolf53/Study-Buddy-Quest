...
(function() {
    try {
        ...
        console.log('Light mode popup error:', err);
    }
})();
</script>
""", height=0)
    ...
    {safe_notes}
        ...
        with st.expander("📜 Generate Your Certificate"):
            ...
            if st.session_state.get('generated_certificate'):
                components.html(st.session_state.generated_certificate, height=812, scrolling=False)
                ...
                components.html(share_btn_html, height=80)
